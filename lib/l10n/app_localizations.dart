...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'In case of any difficulties, contact with us.'**
  ...
  /// No description provided for @pOS_Manager_UCF.
  ///
  /// In en, this message translates to:
  /// **'POS Manager'**
  String get pOS_Manager_UCF;
  ...
  /// No description provided for @pOS_System_UCF.
  ///
  /// In en, this message translates to:
  /// **'POS System'**
  String get pOS_System_UCF;

  /// No description provided for @pOS_Configuration_UCF.
  ///
  /// In en, this message translates to:
  /// **'POS Configuration'**
  String get pOS_Configuration_UCF;

  /// No description provided for @terminal_printer_size.
  ///
  /// In en, this message translates to:
  /// **'Terminal Printer Size'**
  String get terminal_printer_size;

  /// No description provided for @print_width_in_mm.
  ///
  /// In en, this message translates to:
  /// **'Print width in mm'**
  String get print_width_in_mm;

  /// No description provided for @fixed_amount_ucf.
  ///
  /// In en, this message translates to:
  /// **'Fixed Amount'**
  String get fixed_amount_ucf;

  /// No description provided for @ryial_ucf.
  ///
  /// In en, this message translates to:
  /// **'Ryial'**
