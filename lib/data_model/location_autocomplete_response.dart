...
GoogleLocationAutoCompleteResponse googleLocationAutoCompleteResponseFromJson(
  String str,
) => GoogleLocationAutoCompleteResponse.fromJson(json.decode(str));

String googleLocationAutoCompleteResponseToJson(
  GoogleLocationAutoCompleteResponse data,
) => json.encode(data.toJson());

class GoogleLocationAutoCompleteResponse {
  GoogleLocationAutoCompleteResponse({this.predictions, this.status});

  List<Prediction>? predictions;
  String? status;

  factory GoogleLocationAutoCompleteResponse.fromJson(
