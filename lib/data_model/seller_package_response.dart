...
SellerPackageResponse sellerPackageResponseFromJson(String str) =>
    SellerPackageResponse.fromJson(json.decode(str));

String sellerPackageResponseToJson(SellerPackageResponse data) =>
    json.encode(data.toJson());

class SellerPackageResponse {
  SellerPackageResponse({this.data});

  List<Package>? data;

  factory SellerPackageResponse.fromJson(Map<String, dynamic> json) =>
