...
GoogleLocationDetailsResponse googleLocationDetailsResponseFromJson(
  String str,
) => GoogleLocationDetailsResponse.fromJson(json.decode(str));

String googleLocationDetailsResponseToJson(
  GoogleLocationDetailsResponse data,
...
class GoogleLocationDetailsResponse {
  ...
  factory GoogleLocationDetailsResponse.fromJson(Map<String, dynamic> json) =>
      GoogleLocationDetailsResponse(
        htmlAttributions: List<dynamic>.from(
          json["html_attributions"].map((x) => x),
        ),
