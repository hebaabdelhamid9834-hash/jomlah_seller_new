...
Map<String, ChartResponse> chartResponseFromJson(String str) => Map.from(
  json.decode(str),
).map((k, v) => MapEntry<String, ChartResponse>(k, ChartResponse.fromJson(v)));
...
class ChartResponse {
  ...
  ChartResponse({this.date, this.total});

  factory ChartResponse.fromJson(Map<String, dynamic> json) =>
      ChartResponse(date: json["date"], total: json["total"].toDouble());
