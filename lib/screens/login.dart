...
String _countryCode='20';
  ...
  onPressedLogin() async {
    ...
    var loginResponse = await AuthRepository().getLoginResponse(
         _phone,_countryCode, password, _login_by);
    ...
    if (loginResponse.result == true) {
      ...
      print("success${loginResponse.message}");
    } else {
...
String phoneNumber="201115555555";
  ...
  void _openWhatsApp() async {
    ...
    if (await canLaunchUrl(whatsappUri)) {
      ...
      throw 'Could not launch WhatsApp for number ${phoneNumber}';
    }
    //   Utils.launchURL(
    //   'whatsapp://send?${state.socialMediaData.whatsApp}',
    // );
  }
  @override
...
String phoneNumber="966 50 155 2923";
...
class WhatsAppHelper {
  static Future<void> openWhatsApp() async {
    ...
    if (await canLaunchUrl(whatsappUrl)) {
      ...
      throw Exception("Could not launch WhatsApp or Browser");
    }
  }
}