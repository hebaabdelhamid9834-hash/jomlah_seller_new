...
class MyTheme {
  static const Color app_accent_color = Color(0xff0b79bf);
  static Color app_accent_color_extra_light =
      Color.fromRGBO(233, 233, 240, 1.0);

  static Color splash_screen_color = Color(0xff0b79bf); // if not sure , use the same color as accent color
  static Color login_reg_screen_color = Color(0xff0b79bf); // if not sure , use the same color as accent color
